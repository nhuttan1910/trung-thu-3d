...
// Bất kỳ thao tác tương tác nào với trang
// đều có thể kích hoạt nhạc
function handleFirstInteraction(event) {

    // Nếu đang click nút nhạc thì để handler riêng xử lý
